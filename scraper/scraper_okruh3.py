# scraper_okruh3.py  –  vytěží celý okruh 3
# -*- coding: utf-8 -*-
...
OUT    = "okruh3.json"  # Změna pro okruh 3
...
# ---------------------------------------------------------------------------
def get_question_links(okruh=3): # Změna pro okruh 3
...
if __name__ == "__main__":
    links = get_question_links(3) # Změna pro okruh 3
    print(f"Okruh 3: {len(links)} odkazů nalezeno") # Změna pro okruh 3
    all_q  = []
