# scraper_okruh6.py  –  vytěží celý okruh 6
# -*- coding: utf-8 -*-
...
OUT    = "okruh6.json"  # Změna pro okruh 6
...
# ---------------------------------------------------------------------------
def get_question_links(okruh=6): # Změna pro okruh 6
...
if __name__ == "__main__":
    links = get_question_links(6) # Změna pro okruh 6
    print(f"Okruh 6: {len(links)} odkazů nalezeno") # Změna pro okruh 6
    all_q  = []
