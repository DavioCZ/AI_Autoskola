# scraper_okruh7.py  –  vytěží celý okruh 7
# -*- coding: utf-8 -*-
...
OUT    = "okruh7.json"  # Změna pro okruh 7
...
# ---------------------------------------------------------------------------
def get_question_links(okruh=7): # Změna pro okruh 7
...
if __name__ == "__main__":
    links = get_question_links(7) # Změna pro okruh 7
    print(f"Okruh 7: {len(links)} odkazů nalezeno") # Změna pro okruh 7
    all_q  = []
