# scraper_okruh5.py  –  vytěží celý okruh 5
# -*- coding: utf-8 -*-
...
OUT    = "okruh5.json"  # Změna pro okruh 5
...
# ---------------------------------------------------------------------------
def get_question_links(okruh=5): # Změna pro okruh 5
...
if __name__ == "__main__":
    links = get_question_links(5) # Změna pro okruh 5
    print(f"Okruh 5: {len(links)} odkazů nalezeno") # Změna pro okruh 5
    all_q  = []
